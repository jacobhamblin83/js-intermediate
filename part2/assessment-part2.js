...
function frodo (startingHungerValue, startingDangerValue) {
  var newHunger = startingHungerValue
  var newDanger = startingDangerValue
  return {
    dinnerOverFire: function() {
      startingHungerValue -= 25
      if (startingHungerValue < 0) startingHungerValue = 0
      startingDangerValue += 40
      if (startingDangerValue > 100) startingDangerValue = 100
      return {
    ...
    hidingInBush: function() {
      ...
      if (startingHungerValue > 100) startingHungerValue = 100
      startingDangerValue -= 20
      if (startingDangerValue < 0) startingDangerValue = 0
      return {
        hunger: startingHungerValue,
        danger: startingDangerValue
      }
